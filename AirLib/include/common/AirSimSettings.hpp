...
namespace airlib
{
    ...
    public: //types
        ...
        static constexpr char const* kVehicleTypeSIPCharacter = "sipcharacter";
        ...
        static constexpr char const* kSimModeTypeSIPCharacter = "SIPCharacter";
        ...
        {
            std::string pawn_skeletal_mesh;
            std::string pawn_material_path; // the path to the material that can be change with textures
            std::string pawn_cloth_texture_path; // the path to the cloth texture(s)
            std::string pawn_skin_texture_path; 
            std::string joint_1;
            std::string joint_2;
            std::string joint_3;
            std::string joint_4;
            ...
            bool socket_with_spring1;
            bool socket_with_spring2;
            bool socket_with_spring3;
            bool socket_with_spring4;
        ...
        struct VehicleSetting
        {
            ...
            CharacterDefaults vehicle_character_defaults;
    ...
    public: //fields
        ...
        CharacterDefaults character_defaults;
        std::string clock_type = "";
        float clock_speed = 1.0f;
        float runtimeTimeout = -1.0f; // limit the runtime by simtime by setting the time in positive settings
    ...
    private:
        ...
        void loadViewModeSettings(const Settings& settings_json)
        {
            ...
            if (view_mode_string == "") {
                ...
                else if (simmode_name == kSimModeTypeSIPCharacter)
                    view_mode_string = "Fpv";
                else
                                                                    ...
                                                                    const CameraSetting& camera_defaults)
        {
            ...
            //SIP character
            vehicle_setting->vehicle_character_defaults.pawn_skeletal_mesh = settings_json.getString("SkeletalMesh", "");
            vehicle_setting->vehicle_character_defaults.pawn_material_path = settings_json.getString("Material", "Material'/Game/chars/Materials/charMaterial.charMaterial'"); // material that supports the setting of skin and cloth
            vehicle_setting->vehicle_character_defaults.pawn_cloth_texture_path = settings_json.getString("Cloth", "/Game/chars/Materials/clothTextures"); // uasset or folder of usassets
            vehicle_setting->vehicle_character_defaults.pawn_skin_texture_path = settings_json.getString("Skin", "/Game/chars/Materials/skinTextures"); // uasset or folders of uassets
            vehicle_setting->vehicle_character_defaults.joint_1 = settings_json.getString("Socket1", "");
            vehicle_setting->vehicle_character_defaults.joint_2 = settings_json.getString("Socket2", "");
            vehicle_setting->vehicle_character_defaults.joint_3 = settings_json.getString("Socket3", "");
            vehicle_setting->vehicle_character_defaults.joint_4 = settings_json.getString("Socket4", "");
            vehicle_setting->vehicle_character_defaults.joint_5 = settings_json.getString("Socket5", "");
            vehicle_setting->vehicle_character_defaults.joint_6 = settings_json.getString("Socket6", "");

            vehicle_setting->vehicle_character_defaults.socket_with_spring1 = settings_json.getBool("Spring1", false);
            vehicle_setting->vehicle_character_defaults.socket_with_spring2 = settings_json.getBool("Spring2", false);
            vehicle_setting->vehicle_character_defaults.socket_with_spring3 = settings_json.getBool("Spring3", false);
            ...
            vehicle_setting->vehicle_character_defaults.vel_std_dev3 = settings_json.getDouble("AngulerVel_std3", 0.0);
            vehicle_setting->vehicle_character_defaults.vel_std_dev4 = settings_json.getDouble("AngulerVel_std4", 0.0);
            vehicle_setting->vehicle_character_defaults.vel_std_dev5 = settings_json.getDouble("AngulerVel_std5", 0.0);
            vehicle_setting->vehicle_character_defaults.vel_std_dev6 = settings_json.getDouble("AngulerVel_std6", 0.0);

            vehicle_setting->vehicle_character_defaults.acc_std_dev1 = settings_json.getDouble("LinearAcc_std1", 0.0);
            vehicle_setting->vehicle_character_defaults.acc_std_dev2 = settings_json.getDouble("LinearAcc_std2", 0.0);
            vehicle_setting->vehicle_character_defaults.acc_std_dev3 = settings_json.getDouble("LinearAcc_std3", 0.0);
            vehicle_setting->vehicle_character_defaults.acc_std_dev4 = settings_json.getDouble("LinearAcc_std4", 0.0);
            vehicle_setting->vehicle_character_defaults.acc_std_dev5 = settings_json.getDouble("LinearAcc_std5", 0.0);
            vehicle_setting->vehicle_character_defaults.acc_std_dev6 = settings_json.getDouble("LinearAcc_std6", 0.0);

            vehicle_setting->vehicle_character_defaults.cam1x = settings_json.getDouble("Cam1X", 0.0);
            vehicle_setting->vehicle_character_defaults.cam1y = settings_json.getDouble("Cam1Y", 0.0);
            vehicle_setting->vehicle_character_defaults.cam1z = settings_json.getDouble("Cam1Z", 0.0);
            vehicle_setting->vehicle_character_defaults.cam1rotx = settings_json.getDouble("Cam1RotX", 0.0);
            vehicle_setting->vehicle_character_defaults.cam1roty = settings_json.getDouble("Cam1RotY", 0.0);
            vehicle_setting->vehicle_character_defaults.cam1rotz = settings_json.getDouble("Cam1RotZ", 0.0);

            vehicle_setting->vehicle_character_defaults.cam2x = settings_json.getDouble("Cam2X", 0.0);
            vehicle_setting->vehicle_character_defaults.cam2y = settings_json.getDouble("Cam2Y", 0.0);
            vehicle_setting->vehicle_character_defaults.cam2z = settings_json.getDouble("Cam2Z", 0.0);
            vehicle_setting->vehicle_character_defaults.cam2rotx = settings_json.getDouble("Cam2RotX", 0.0);
            vehicle_setting->vehicle_character_defaults.cam2roty = settings_json.getDouble("Cam2RotY", 0.0);
            vehicle_setting->vehicle_character_defaults.cam2rotz = settings_json.getDouble("Cam2RotZ", 0.0);

            vehicle_setting->vehicle_character_defaults.cam3x = settings_json.getDouble("Cam3X", 0.0);
            vehicle_setting->vehicle_character_defaults.cam3y = settings_json.getDouble("Cam3Y", 0.0);
            vehicle_setting->vehicle_character_defaults.cam3z = settings_json.getDouble("Cam3Z", 0.0);
            vehicle_setting->vehicle_character_defaults.cam3rotx = settings_json.getDouble("Cam3RotX", 0.0);
            vehicle_setting->vehicle_character_defaults.cam3roty = settings_json.getDouble("Cam3RotY", 0.0);
            vehicle_setting->vehicle_character_defaults.cam3rotz = settings_json.getDouble("Cam3RotZ", 0.0);

            vehicle_setting->vehicle_character_defaults.cam4x = settings_json.getDouble("Cam4X", 0.0);
            vehicle_setting->vehicle_character_defaults.cam4y = settings_json.getDouble("Cam4Y", 0.0);
            vehicle_setting->vehicle_character_defaults.cam4z = settings_json.getDouble("Cam4Z", 0.0);
            vehicle_setting->vehicle_character_defaults.cam4rotx = settings_json.getDouble("Cam4RotX", 0.0);
            vehicle_setting->vehicle_character_defaults.cam4roty = settings_json.getDouble("Cam4RotY", 0.0);
            vehicle_setting->vehicle_character_defaults.cam4rotz = settings_json.getDouble("Cam4RotZ", 0.0);

            vehicle_setting->vehicle_character_defaults.cam5x = settings_json.getDouble("Cam5X", 0.0);
            vehicle_setting->vehicle_character_defaults.cam5y = settings_json.getDouble("Cam5Y", 0.0);
            vehicle_setting->vehicle_character_defaults.cam5z = settings_json.getDouble("Cam5Z", 0.0);
            vehicle_setting->vehicle_character_defaults.cam5rotx = settings_json.getDouble("Cam5RotX", 0.0);
            vehicle_setting->vehicle_character_defaults.cam5roty = settings_json.getDouble("Cam5RotY", 0.0);
            vehicle_setting->vehicle_character_defaults.cam5rotz = settings_json.getDouble("Cam5RotZ", 0.0);

            vehicle_setting->vehicle_character_defaults.cam6x = settings_json.getDouble("Cam6X", 0.0);
            vehicle_setting->vehicle_character_defaults.cam6y = settings_json.getDouble("Cam6Y", 0.0);
            vehicle_setting->vehicle_character_defaults.cam6z = settings_json.getDouble("Cam6Z", 0.0);
            vehicle_setting->vehicle_character_defaults.cam6rotx = settings_json.getDouble("Cam6RotX", 0.0);
            vehicle_setting->vehicle_character_defaults.cam6roty = settings_json.getDouble("Cam6RotY", 0.0);
            vehicle_setting->vehicle_character_defaults.cam6rotz = settings_json.getDouble("Cam6RotZ", 0.0);
                                         ...
                                         const std::map<std::string, std::shared_ptr<SensorSetting>>& sensor_defaults)
        {
            ...
            if (simmode_name == kSimModeTypeMultirotor) {
                ...
                // create default SIPCharacter vehicle
                auto char_setting = std::unique_ptr<VehicleSetting>(new VehicleSetting("SIPCharacter", kVehicleTypeSIPCharacter));
                char_setting->sensors = sensor_defaults;
                vehicles[char_setting->vehicle_name] = std::move(char_setting);
            }
            else {
        ...
        static void initializePawnPaths(std::map<std::string, PawnPath>& pawn_paths)
        {
            ...
            pawn_paths.emplace("DefaultSIPCharacter",
                               PawnPath("Class'/AirSim/Blueprints/BP_SIPCharacterPawn.BP_SIPCharacterPawn_C'"));
        }
        ...
        void loadOtherSettings(const Settings& settings_json)
        {
            ...
            character_defaults.pawn_skeletal_mesh = settings_json.getString("SkeletalMesh", "");
            character_defaults.pawn_material_path = settings_json.getString("Material", "Material'/Game/chars/Materials/charMaterial.charMaterial'"); // material that supports the setting of skin and cloth
            character_defaults.pawn_cloth_texture_path = settings_json.getString("Cloth", "/Game/chars/Materials/clothTextures"); // uasset or folder of usassets
            character_defaults.pawn_skin_texture_path = settings_json.getString("Skin", "/Game/chars/Materials/skinTextures"); // uasset or folders of uassets
            character_defaults.joint_1 = settings_json.getString("Socket1", "");
            character_defaults.joint_2 = settings_json.getString("Socket2", "");
            character_defaults.joint_3 = settings_json.getString("Socket3", "");
            character_defaults.joint_4 = settings_json.getString("Socket4", "");
            character_defaults.joint_5 = settings_json.getString("Socket5", "");
            character_defaults.joint_6 = settings_json.getString("Socket6", "");

            character_defaults.socket_with_spring1 = settings_json.getBool("Spring1", false);
            character_defaults.socket_with_spring2 = settings_json.getBool("Spring2", false);
            character_defaults.socket_with_spring3 = settings_json.getBool("Spring3", false);
            character_defaults.socket_with_spring4 = settings_json.getBool("Spring4", false);
            character_defaults.socket_with_spring5 = settings_json.getBool("Spring5", false);
            character_defaults.socket_with_spring6 = settings_json.getBool("Spring6", false);

            character_defaults.vel_std_dev1 = settings_json.getDouble("AngulerVel_std1", 0.0);
            character_defaults.vel_std_dev2 = settings_json.getDouble("AngulerVel_std2", 0.0);
            character_defaults.vel_std_dev3 = settings_json.getDouble("AngulerVel_std3", 0.0);
            character_defaults.vel_std_dev4 = settings_json.getDouble("AngulerVel_std4", 0.0);
            character_defaults.vel_std_dev5 = settings_json.getDouble("AngulerVel_std5", 0.0);
            character_defaults.vel_std_dev6 = settings_json.getDouble("AngulerVel_std6", 0.0);

            character_defaults.acc_std_dev1 = settings_json.getDouble("LinearAcc_std1", 0.0);
            character_defaults.acc_std_dev2 = settings_json.getDouble("LinearAcc_std2", 0.0);
            character_defaults.acc_std_dev3 = settings_json.getDouble("LinearAcc_std3", 0.0);
            character_defaults.acc_std_dev4 = settings_json.getDouble("LinearAcc_std4", 0.0);
            character_defaults.acc_std_dev5 = settings_json.getDouble("LinearAcc_std5", 0.0);
            character_defaults.acc_std_dev6 = settings_json.getDouble("LinearAcc_std6", 0.0);

            character_defaults.cam1x = settings_json.getDouble("Cam1X", 0.0);
            character_defaults.cam1y = settings_json.getDouble("Cam1Y", 0.0);
            character_defaults.cam1z = settings_json.getDouble("Cam1Z", 0.0);
            character_defaults.cam1rotx = settings_json.getDouble("Cam1RotX", 0.0);
            character_defaults.cam1roty = settings_json.getDouble("Cam1RotY", 0.0);
            character_defaults.cam1rotz = settings_json.getDouble("Cam1RotZ", 0.0);

            character_defaults.cam2x = settings_json.getDouble("Cam2X", 0.0);
            character_defaults.cam2y = settings_json.getDouble("Cam2Y", 0.0);
            character_defaults.cam2z = settings_json.getDouble("Cam2Z", 0.0);
            character_defaults.cam2rotx = settings_json.getDouble("Cam2RotX", 0.0);
            character_defaults.cam2roty = settings_json.getDouble("Cam2RotY", 0.0);
            character_defaults.cam2rotz = settings_json.getDouble("Cam2RotZ", 0.0);

            character_defaults.cam3x = settings_json.getDouble("Cam3X", 0.0);
            character_defaults.cam3y = settings_json.getDouble("Cam3Y", 0.0);
            character_defaults.cam3z = settings_json.getDouble("Cam3Z", 0.0);
            character_defaults.cam3rotx = settings_json.getDouble("Cam3RotX", 0.0);
            character_defaults.cam3roty = settings_json.getDouble("Cam3RotY", 0.0);
            character_defaults.cam3rotz = settings_json.getDouble("Cam3RotZ", 0.0);

            character_defaults.cam4x = settings_json.getDouble("Cam4X", 0.0);
            character_defaults.cam4y = settings_json.getDouble("Cam4Y", 0.0);
            character_defaults.cam4z = settings_json.getDouble("Cam4Z", 0.0);
            character_defaults.cam4rotx = settings_json.getDouble("Cam4RotX", 0.0);
            character_defaults.cam4roty = settings_json.getDouble("Cam4RotY", 0.0);
            character_defaults.cam4rotz = settings_json.getDouble("Cam4RotZ", 0.0);

            character_defaults.cam5x = settings_json.getDouble("Cam5X", 0.0);
            character_defaults.cam5y = settings_json.getDouble("Cam5Y", 0.0);
            character_defaults.cam5z = settings_json.getDouble("Cam5Z", 0.0);
            character_defaults.cam5rotx = settings_json.getDouble("Cam5RotX", 0.0);
            character_defaults.cam5roty = settings_json.getDouble("Cam5RotY", 0.0);
            character_defaults.cam5rotz = settings_json.getDouble("Cam5RotZ", 0.0);

            character_defaults.cam6x = settings_json.getDouble("Cam6X", 0.0);
            character_defaults.cam6y = settings_json.getDouble("Cam6Y", 0.0);
            character_defaults.cam6z = settings_json.getDouble("Cam6Z", 0.0);
            character_defaults.cam6rotx = settings_json.getDouble("Cam6RotX", 0.0);
            character_defaults.cam6roty = settings_json.getDouble("Cam6RotY", 0.0);
            character_defaults.cam6rotz = settings_json.getDouble("Cam6RotZ", 0.0);
        ...
        void loadClockSettings(const Settings& settings_json)
        {
            ...
            runtimeTimeout = settings_json.getFloat("RuntimeTimeout", -1.0f);
        }
