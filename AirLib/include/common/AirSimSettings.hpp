...
namespace airlib
{
    ...
    private:
                                                                    ...
                                                                    const CameraSetting& camera_defaults)
        {
            ...
            //SIP character
            vehicle_setting->vehicle_character_defaults.pawn_skeletal_mesh = settings_json.getString("CharacterBp", "");
            vehicle_setting->vehicle_character_defaults.pawn_animation = settings_json.getString("AnimationBp", "");
            vehicle_setting->vehicle_character_defaults.socket_1 = settings_json.getString("Socket1", "");
            vehicle_setting->vehicle_character_defaults.socket_2 = settings_json.getString("Socket2", "");
            vehicle_setting->vehicle_character_defaults.socket_3 = settings_json.getString("Socket3", "");
            vehicle_setting->vehicle_character_defaults.socket_4 = settings_json.getString("Socket4", "");
            vehicle_setting->vehicle_character_defaults.socket_5 = settings_json.getString("Socket5", "");
            vehicle_setting->vehicle_character_defaults.socket_6 = settings_json.getString("Socket6", "");
        ...
        void loadOtherSettings(const Settings& settings_json)
        {
            ...
            character_defaults.pawn_skeletal_mesh = settings_json.getString("CharacterBp", "");
            character_defaults.pawn_animation = settings_json.getString("AnimationBp", "");
            character_defaults.socket_1 = settings_json.getString("Socket1", "");
            character_defaults.socket_2 = settings_json.getString("Socket2", "");
            character_defaults.socket_3 = settings_json.getString("Socket3", "");
            character_defaults.socket_4 = settings_json.getString("Socket4", "");
            character_defaults.socket_5 = settings_json.getString("Socket5", "");
            character_defaults.socket_6 = settings_json.getString("Socket6", "");
