...
private:
    ...
    UPROPERTY()
    const USkeletalMeshSocket* Socket1;
    UPROPERTY()
    const USkeletalMeshSocket* Socket2;
    UPROPERTY()
    const USkeletalMeshSocket* Socket3;
    UPROPERTY()
    const USkeletalMeshSocket* Socket4;
    UPROPERTY()
    const USkeletalMeshSocket* Socket5;
    UPROPERTY()
    const USkeletalMeshSocket* Socket6;
