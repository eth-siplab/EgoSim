                ...
                .SetDefaultSubobjectClass<UCineCameraComponent>(TEXT("CameraComponent")))
{
    ...
    image_type_to_pixel_format_map_.Add(Utils::toNumeric(ImageType::Fisheye), EPixelFormat::PF_B8G8R8A8); //Fisheye
...
void APIPCamera::PostInitializeComponents()
{
    ...
    captures_[Utils::toNumeric(ImageType::Fisheye)] =
        UAirBlueprintLib::GetActorComponent<USceneCaptureComponent2D>(this, TEXT("FisheyeCaptureComponent"));
